...
export default function BillingPOSFeature() {
  const items = [
    { title: "FBR Invoicing", desc: "Built-in integration for FBR-compliant QR-coded invoices for feed retail shops and veterinary pharmacies." },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "FBR Invoicing & Retail POS ERP (AnimalCare360)",
            "operatingSystem": "All (Web & Android)",
            "applicationCategory": "BusinessApplication",
            "description": "FBR QR-coded receipts, retail POS screens, customer khata books, supplier payable ledgers, and profit calculations for veterinary clinics and feed stores."
          })
        }}
      />
        ...
        <div className="section-container relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-8 leading-tight">
              FBR Invoicing & Retail POS
            </h1>
            <p className="text-xl text-slate-300 leading-relaxed mb-10">
              Run retail wanda shops, pet hospitals, and clinical pharmacies with FBR-compliant billing terminals. Automate credit ledger accounting and monitor transaction margins.
            </p>
      ...
      <section className="py-24 bg-white">
        <div className="section-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            <div>
              <h2 className="text-3xl font-bold text-brand-navy mb-6 tracking-tight">Unified Khata & Financial Registers</h2>
              <p className="text-brand-muted text-base leading-relaxed mb-6">
                Connect retail transactions with overall accounts. AnimalCare360 links point-of-sale activities directly to accounting books. Track vendor payable entries, maintain customer khata profiles, generate printable invoice forms, and verify monthly profits.
              </p>
              <ul className="space-y-4">
                {["FBR-ready POS with QR receipts", "Integrated customer credit ledger", "Auto-updates on store stock counts", "Double-entry financial reporting"].map((item, idx) => (
